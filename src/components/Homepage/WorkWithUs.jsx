    ...
    return ( 
            <>
                <div className='w-full   bg-white flex justify-center py-[2.5rem] '>
                    <div className='w-[94%] bg-gray-300 px-5 flex flex-col pt-16 gap-10 rounded-3xl'>
                        ...
                        <div id='work-with-us-content' className='flex flex-col gap-8'>
                            <div className='flex flex-col md:flex-row md:h-[auto] items-baseline'>
                                ...
                                <div className='flex flex-col text-center gap-5 w-[90%] md:w-[35%] md:h-[18rem] p-2 '>
                                    ...
                                    <p className='text-xl'>
                                      We believe in building long-term relationships with our clients through honesty, integrity, and full transparency in all our transactions.
                                    </p>
                                </div>
                                </div>
                                <div className='flex flex-col md:flex-row md:h-[auto] items-baseline'>
                                ...
                                <div className='flex flex-col gap-5 text-center w-[90%] md:w-[35%] md:h-[full] lg:h-[18rem] p-5 '>
                                    ...
                                    <p className='text-xl'>
                                         Partnering with us means joining a company that’s on the rise. As a startup, we’re agile, forward-thinking, and focused on creating value for our clients and investors.
                                    </p>
                                </div>
                                ...
                                <div className='flex flex-col gap-5 text-center w-[90%] md:w-[45%] md:h-[full] lg:h-[18rem] p-5 '>
                                    ...
                                    <p className='text-xl'>
                                         We measure our success by how well we help you achieve your real estate goals. Your satisfaction drives everything we do.
                                    </p>
                                </div>
