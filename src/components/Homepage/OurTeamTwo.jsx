...
const OurTeamTwo = () => {
  ...
  return (    
          ...
          <div id='our-team-container' className='flex flex-col w-[94%] overflow-hidden bg-gray-300 px-5 py-20 rounded-3xl '>
               ...
               >
                <AnimatePresence mode="wait">
                  ...
                  >
                        ...
                        className="member-img h-[25rem] w-[full] md:w-[20rem] flex justify-center items-center rounded-3xl  border-2 border-white">
                          <img src={selectedMember.image} alt='image of team member' className='w-full h-full rounded-3xl object-center object-cover'/>
                        </div>
                        <div
                        d
                        className='flex flex-col gap-2 md:h-[25rem] bg-black text-white rounded-2xl p-10 justify-center md:w-[60%] border-2 border-black'>
                        ...
                        className='h-[4rem] p-2 w-full md:w-[4rem] text-white rounded-full bg-black hover:cursor-pointer flex justify-center items-center' onClick={()=>{
                          ...
                          teamContainerRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' })}}><IoArrowBack size={30}/>
                          </motion.div>
                        </motion.div>
                  ): (  <motion.div
                    key="swiper"
           ...
           {teamMockup.team.map((member, index) => (
             ...
             <SwiperSlide  key={member.name} >
               ...
               className='slide h-[25rem] w-[full] text-[#d7fdff] md:h-[25rem] lg:h-[28rem] p-5 bg-black mt-10 mb-5 mx-10 flex flex-col items-start justify-end rounded-3xl border-2 border-white ' style={{backgroundImage: `url(${member.image})`, backgroundPosition:'center', backgroundSize:'cover'}}>
  ...
  <div>
    ...
    >
      <FaAngleRight size={60} className='hover:cursor-pointer text-white'/>
              ...
              data-aos='fade-up'
              data-aos-offset="300"
              id='our-team-info' className='flex flex-col justify-center md:flex-row w-full text-center mb-4 gap-x-10'>
              ...
              data-aos='fade-up'
              data-aos-offset="300"
              id='our-team-info' className='flex flex-col md:flex-row w-full text-center gap-x-10'>
                <p className='text-xl my-4  p-5 border-opacity-40 w-[100%] md:w-[45%]'>
